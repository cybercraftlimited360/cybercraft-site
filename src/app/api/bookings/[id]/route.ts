  ...
  <div style="max-width:520px;margin:0 auto;background:#0f1117;border-radius:16px;border:1px solid rgba(255,255,255,0.07);overflow:hidden;">
    ...
    <div style="padding:36px;">
      ...
      <div style="background:rgba(0,212,255,0.05);border:1px solid rgba(0,212,255,0.2);border-radius:12px;padding:20px 24px;margin-bottom:28px;">
        <div style="margin-bottom:12px;"><div style="font-size:11px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:0.1em;margin-bottom:2px;">New Date</div><div style="color:#fff;font-weight:600;font-size:15px;">${dateLabel}</div></div>
        <div><div style="font-size:11px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:0.1em;margin-bottom:2px;">New Time</div><div style="color:#fff;font-weight:600;font-size:15px;">${fmt12(time)} CT</div></div>
      </div>
      <p style="font-size:12px;color:rgba(255,255,255,0.3);margin:0 0 0;">Need to change again? <a href="${baseUrl}/reschedule/${id}" style="color:#00d4ff;">Click here</a>.</p>
    </div>
  </div>
</div>`,
      }),
