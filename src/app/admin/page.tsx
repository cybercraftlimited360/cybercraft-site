...
function Row({children,border,style,onClick}:{children:React.ReactNode;border?:boolean;style?:React.CSSProperties;onClick?:()=>void}){return <div style={{padding:"14px 16px",borderTop:border?"1px solid rgba(255,255,255,0.05)":"none",display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:10,...style}} onClick={onClick}>{children}</div>;}
